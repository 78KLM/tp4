<div class="container mt-5">
        <div class="row pt-3"> 
            <div class="col-9"><h2>Liste des livre</h2></div>
            <div class="col-3"><a href='index.php?uc=livre&action=add' class='btn btn-success'><i class='fa-solid fa-plus'></i>Crée un livre </a></div>
    ...
    <div class="row">
      ...
      <select name="auteur" class='form-control'> 
              <?php 
              echo "<option value='Tous'>Tout les auteur</option>";
      ...
      <select name="genre" class='form-control'> 
              <?php 
              echo "<option value='Tous'>Tout les genre</option>";
